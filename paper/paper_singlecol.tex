...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{paper/figures/system_architecture.png}
...
\centering
\includegraphics[height=3.1cm,width=\linewidth,keepaspectratio]{test/shaniwar_wada_cropped.jpg}
\caption*{(a) Regular Shaniwar Wada image}
\end{minipage}\hfill
\begin{minipage}{0.45\linewidth}
\centering
\includegraphics[height=3.1cm,width=\linewidth,keepaspectratio]{test/shaniwar_wada_flames_cropped.png}
...
\bibliography{report format/biblo}
