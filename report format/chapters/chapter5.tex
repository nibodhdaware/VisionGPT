...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{../paper/figures/system_architecture.png}}
...
\centering
\includegraphics[height=5.2cm,width=\linewidth,keepaspectratio]{"../test/shaniwar wada.jpg"}
\caption{Regular Shaniwar Wada image}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}
\centering
\includegraphics[height=5.2cm,width=\linewidth,keepaspectratio]{"../test/shaniwar wada in flames.png"}
